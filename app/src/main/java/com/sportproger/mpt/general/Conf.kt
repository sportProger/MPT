...
object Conf {
    ...
    const val PRICE_FOR_CORRECT_DEGREE_ANSWER = 5
    const val PRICE_FOR_WRONG_DEGREE_ANSWER = -4

    const val PRICE_FOR_CORRECT_LINEAR_FUNCTIONS_ANSWER = 6
    const val PRICE_FOR_WRONG_LINEAR_FUNCTIONS_ANSWER = -5

    const val PRICE_FOR_CORRECT_LOGARITHM_ANSWER = 7
    const val PRICE_FOR_WRONG_LOGARITHM_ANSWER = -6

    const val PRICE_FOR_INTEGERS = 0
    const val PRICE_FOR_MODULES = 50
    const val PRICE_FOR_FRACTION = 100
    const val PRICE_FOR_DEGREE = 150
    const val PRICE_FOR_LINEAR_FUNCTIONS = 200
    const val PRICE_FOR_LOGARITHM = 250
